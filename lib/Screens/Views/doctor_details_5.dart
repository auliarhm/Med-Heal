...
class DoctorDetails5 extends StatefulWidget {
  const DoctorDetails5({super.key});

  @override
  _DoctorDetails5State createState() => _DoctorDetails5State();
}

class _DoctorDetails5State extends State<DoctorDetails5> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          showExtendedText
                              ? "Dr. Dian F adalah seorang spesialis Anak berpengalaman yang telah menangani berbagai keluhan Anak. Beliau menyelesaikan pendidikan spesialis di Seoul National University dan memiliki pengalaman klinis selama lebih dari 4 tahun."
                              : "Dr. Dian F adalah seorang spesialis Anak berpengalaman yang telah menangani berbagai keluhan Anak... ",
                          style: GoogleFonts.poppins(
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: showExtendedText
                                ...
                                : const Color.fromARGB(255, 26, 74, 98), 
                          ),
                        ),
                      ],
                    ),
