...
class Appointment3 extends StatefulWidget {
  ...
  @override
  _Appointment3State createState() => _Appointment3State();
}
  ...
  Future<void> _sendData() async {
    ...
    try {
      final data = {
        ...
        'keluhan': 'Periksa/Konsultasi Mata',
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 10),
                  const Text("Periksa/Konsultasi Mata"),
                ],
              ),
            ),
            const SizedBox(height: 20),
            ...
            Padding(
              ...
              child: Column(
                children: [
                  _buildPaymentRow("Pemeriksaan/Konsultasi", "Rp. 250.000"),
                  _buildPaymentRow("Biaya Pelayanan", "Rp. 50.000"),
                  const Divider(),
                  _buildPaymentRow("Total", "Rp. 300.000",
